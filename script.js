...
const els = {
  ...
  attendanceSearchInput: document.getElementById("attendance-search-input"),
  directoryCount: document.getElementById("directory-count"),
  directoryPresentCount: document.getElementById("directory-present-count"),
  ...
  photoArchiveList: document.getElementById("photo-archive-list"),
